...
abstract public class HelperFunctions {
	...
	public static void loadIcons() {
		...
		graphicExtensions = new LinkedList<String>(
				Arrays.asList("png", "jpg", "ico", "jpeg", "tif", "tiff", "bmp", "raw"));
		...
		try {
			...
			JOptionPane.showMessageDialog(new JFrame(),
					"<html><center>Could not load all icon images.<br/>" + e.getMessage() + "</center></html>",
	...
	public static Image getIcon(FileFolderObject ffo, ViewMode vm) {
		...
		if (vm == ViewMode.ListView || vm == ViewMode.DetailedView) {
			...
			// should never happen, but better to have one there than to mess up the
			// display...
			return genericFileIcon16;
		}
	}
